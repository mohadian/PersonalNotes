...
final public class GDActions {
    ...
    public static void init(NoteDetailActivity ctx, String email) {
    ...
    public static void init(NotesActivity ctx, String email) {
        if (ctx != null && email != null) {
            mGAC = new GoogleApiClient.Builder(ctx).addApi(Drive.API)
                    .addScope(Drive.SCOPE_FILE).setAccountName(email)
                    .addConnectionCallbacks(ctx).addOnConnectionFailedListener(ctx).build();
    ...
    public static ArrayList<GF> search(DriveId prId, String titl, String mime) {
    ...
    public static ArrayList<GF> search(String prId, String titl, String mime) {
        ArrayList<GF> gfs = new ArrayList<>();
    ...
    public static String create(String prId, String titl, String mime, byte[] buf) {
        String rsid = null;
